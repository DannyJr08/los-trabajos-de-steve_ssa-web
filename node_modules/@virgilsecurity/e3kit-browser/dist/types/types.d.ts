import { VIRGIL_STREAM_SIGNING_STATE, VIRGIL_STREAM_ENCRYPTING_STATE, VIRGIL_STREAM_VERIFYING_STATE, VIRGIL_STREAM_DECRYPTING_STATE } from './constants';
export declare type NodeBuffer = import('@virgilsecurity/e3kit-base').NodeBuffer;
export declare type Data = import('@virgilsecurity/e3kit-base').Data;
export declare type StringEncoding = import('@virgilsecurity/e3kit-base').StringEncoding;
export declare type ICard = import('@virgilsecurity/e3kit-base').ICard;
export declare type IPublicKey = import('@virgilsecurity/e3kit-base').IPublicKey;
export declare type EThreeBaseInitializeOptions = import('@virgilsecurity/e3kit-base').EThreeInitializeOptions;
export declare type EThreeBaseCtorOptions = import('@virgilsecurity/e3kit-base').EThreeCtorOptions;
export declare type FindUsersResult = import('@virgilsecurity/e3kit-base').FindUsersResult;
export declare type LookupResult = import('@virgilsecurity/e3kit-base').LookupResult;
export declare type KeyPairType = import('virgil-crypto').KeyPairType;
export declare type VirgilCrypto = import('virgil-crypto').VirgilCrypto;
export declare type VirgilPrivateKey = import('virgil-crypto').VirgilPrivateKey;
...
export interface EThreeInitializeOptions extends EThreeBaseInitializeOptions, FoundationLibraryOptions, PythiaLibraryOptions {
 ...
 */
export declare type onEncryptProgressCallback = (snapshot: onEncryptProgressSnapshot) => void;
/**
 * Callback invoked for each chunk being processed in decryptFile method.
 */
export declare type onDecryptProgressCallback = (snapshot: onDecryptProgressSnapshot) => void;
/**
 * Callback invoked for each chunk being processed in decryptFile method.
 */
export declare type onProgressCallback = (snapshot: onProgressSnapshot) => void;
/**
 * `eThree.encryptSharedFile` method resulting object.
 */
export declare type EncryptSharedFileResult = {
