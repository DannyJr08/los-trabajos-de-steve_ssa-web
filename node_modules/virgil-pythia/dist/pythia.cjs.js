...
class PythiaClient {
    constructor(accessTokenProvider, apiUrl, virgilAgent) {
        ...
        this.virgilAgent =
            ...
            virgilAgent || new virgilSdk.VirgilAgent("pythia", "1.0.2");
