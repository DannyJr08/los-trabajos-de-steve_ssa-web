        ...
        return new Promise(function (resolve, reject) {
            fs.readdir(_this.config.dir, function (err, files) {
                ...
                Promise.all(files.map(function (filename) {
                    ...
                    var entries = contents.filter(function (content) { return content !== null; });
                    resolve(entries);
                }).catch(reject);
            });
        });
...
function resolveAdapter(config) {
    ...
    return new FileSystemStorageAdapter(__assign(__assign({}, DEFAULTS$1), rest));
}
...
function resolveAdapter$1(config) {
    ...
    return new FileSystemStorageAdapter(__assign(__assign({}, DEFAULTS$2), rest));
}
